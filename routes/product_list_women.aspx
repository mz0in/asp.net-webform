                                ...
                                <ItemTemplate>
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="single_product_item">
                                            ...
                                            <h3>
                                                <asp:Label ID="Label_name" runat="server" Text='<%# Eval("name")%>'></asp:Label></h3>
                                            <p>
                                                <asp:Label ID="Label_price" runat="server" Text='<%# string.Format("${0:00.00}", double.Parse(Eval("price").ToString()))%>'></asp:Label></p>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
