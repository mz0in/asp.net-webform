<%@ Page Title="" Language="C#" MasterPageFile="~/BeforeLogin.Master" AutoEventWireup="true" CodeBehind="product_list_men.aspx.cs" Inherits="AWAD_Assignment.routes.product_list_men" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Men's clothes</asp:Content>
                        ...
                        <div class="single_sedebar">
                            <div class="select_option">
                                ...
                                <div class="select_option_dropdown">
                                    ...
                                    <p><%--<a runat="server" id="anchorCategory3" onserverclick="GetMenTops_CasualShirts_ServerClick" >Category 3</a>--%></p>
                                    <%--<p><asp:LinkButton runat="server" /> Category 4</p>--%>
                                </div>
                            </div>
                        </div>
                    </div>
